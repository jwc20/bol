...
def find_path_recursive(currentNode, sequence, sequenceIndex):
    # if currentNode is None and sequenceIndex == len(sequence) : return False
    if currentNode is None:
        return False
    # if sequenceIndex == len(sequence) : return False
    ...
    if (
        ...
        and sequenceIndex == len(sequence) - 1
    ):
        return True
...
# Grokking solution
# =================================================
def find_path1(root, sequence):
    if not root:
        return len(sequence) == 0
    return find_path_recursive(root, sequence, 0)


def find_path_recursive1(currentNode, sequence, sequenceIndex):
    if currentNode is None:
        return False
    seqLen = len(sequence)
...
def main():
    ...
    print("Tree has path sequence: " + str(find_path(root, [5, 2, 4, 8])))
    print("Tree has path sequence: " + str(find_path(root, [5, 3, 4, 9])))
